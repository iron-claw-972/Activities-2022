...
public class Drivetrain extends SubsystemBase {
  ...
  WPI_TalonFX leftMotor1 = MotorFactory.createTalonFX(2);
  WPI_TalonFX rightMotor1 = MotorFactory.createTalonFX(1);
  ...
  public void tankDrive(double leftPower, double rightPower) {
    ...
    // ightMotor1.set(ControlMode.PercentOutput, rightPower);
