...
public class Drivetrain extends SubsystemBase {
  ...
  WPI_TalonFX leftMotor1 = MotorFactory.createTalonFX(Constants.drive.kRightMotor);
  WPI_TalonFX rightMotor1 = MotorFactory.createTalonFX(Constants.drive.kLeftMotor);
